...
downward_peak_threshold = 110  # Value when the sensor is pressed (down peak)
upward_peak_threshold = 400  # Value when the sensor is released (up peak)
...
min_time_interval = 0.8  # Minimum time between two cycles in milliseconds
